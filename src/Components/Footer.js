...
export default function Footer() {
  return (
    <>
    <footer className='bg-gradient-to-t from-[#082842cd] to-[#062423f3] p-4'>
        <div className=" flex flex-row flex-wrap ipadmini:justify-around justify:start  px-7">
            <div className="p-4">
                <span className=" text-2xl  text-zinc-100">Sumit's Portfolio</span>
                <div className="flex flex-col justify-center  gap-y-2 mt-3">
                <div className="text-stone-300 max-w-72">Hello! I’m Sumit Patel, a B-Tech student passionate about technology and full-stack development. Let’s connect and explore the exciting world of tech together! 🚀</div>
                </div>
            </div>
            <div className=" p-4">
                <div className=" text-2xl  text-zinc-100">QuickLinks</div>
                <div className="flex flex-col justify-center ps-2 gap-y-1 mt-3">
                <span className="text-stone-300 flex hover:text-amber-500 hover:ps-1 transition-all">
                   
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M6 12 3.269 3.125A59.769 59.769 0 0 1 21.485 12 59.768 59.768 0 0 1 3.27 20.875L5.999 12Zm0 0h7.5" />
                    </svg>
                   
                    <Link to='/cyberknightcycure' className="ps-1">cyber knight cycure</Link>
                </span>
                <span className="text-stone-300 flex hover:text-amber-500 hover:ps-1 transition-all">
                   ...
                   <Link to='/bytebond' className="ps-1">byteBond</Link>
               </span>
               <span className="text-stone-300 flex hover:text-amber-500 hover:ps-1 transition-all">
                   ...
                   <Link to='/cyber-guardians' className="ps-1">Cyber-Guardians</Link>
               </span>
               <span className="text-stone-300 flex hover:text-amber-500 hover:ps-1 transition-all">
                   ...
                   <i className="ps-1">Backend Microservices</i>
               </span>
               <span className="text-stone-300 flex hover:text-amber-500 hover:ps-1 transition-all">
                   ...
                   <i className="ps-1">Spring Boot Project</i>
               </span>
               <span className="text-stone-300 flex hover:text-amber-500 hover:ps-1 transition-all">
                   ...
                   <i className="ps-1">portfolio</i>
               </span>
                   </div>

            </div>
            <div className="p-4">
            <div className=" text-2xl  text-zinc-100">Contact Info</div>
            <div className="flex flex-col justify-center ps-2 gap-y-1 mt-3">
            <span className="text-stone-300 flex hover:text-amber-500 hover:ps-1 transition-all">
               ...
               <span className="text-stone-300 flex hover:text-amber-500 hover:ps-1 transition-all">
                   ...
                   <i className="ps-1">sumitpatel28855@gmail.com</i>
               </span>
               <span className="text-stone-300 flex hover:text-amber-500 hover:ps-1 transition-all">
                   ...
                   <i className="ps-1">github.com/sumit4902</i>
               </span>
               <br />
             
            <div className=" flex flex-row justify-around w-full gap-x-2">
                            <a href='https://www.facebook.com/sumitpatel.patel.7146?mibextid=ZbWKwL' target='/' className=""> <svg class="relative border rounded-full z-10 fill-rose-100 transition-all duration-300 hover:fill-orange-500 " xmlns="http://www.w3.org/2000/svg" width="38" height="38" viewBox="0 0 72 72" fill="none">
                                <path
                                    d="M46.4927 38.6403L47.7973 30.3588H39.7611V24.9759C39.7611 22.7114 40.883 20.4987 44.4706 20.4987H48.1756V13.4465C46.018 13.1028 43.8378 12.9168 41.6527 12.8901C35.0385 12.8901 30.7204 16.8626 30.7204 24.0442V30.3588H23.3887V38.6403H30.7204V58.671H39.7611V38.6403H46.4927Z"
                                    fill="" />
                            </svg></a>
                            <a href='https://www.instagram.com/sumit_patel.ss/' target='/' className="">
                            ...
                            <a href='https://x.com/SumitPatel87909?t=0vsnpMpg9R2pTkN6edqBhA&s=09' target='/' className=""> <svg class="fill-white cursor-pointer border rounded-full p-1 z-10 transition-all duration-300 hover:fill-orange-500" xmlns="http://www.w3.org/2000/svg" width="38" height="38" viewBox="0 0 72 72" fill="none">
                                <path
                                    d="M40.7568 32.1716L59.3704 11H54.9596L38.7974 29.383L25.8887 11H11L30.5205 38.7983L11 61H15.4111L32.4788 41.5869L46.1113 61H61L40.7557 32.1716H40.7568ZM34.7152 39.0433L32.7374 36.2752L17.0005 14.2492H23.7756L36.4755 32.0249L38.4533 34.7929L54.9617 57.8986H48.1865L34.7152 39.0443V39.0433Z"
                                    fill="" />
                            </svg></a>
                            <a href='https://www.linkedin.com/in/sumit-patel-25223a234' target='/' className="">
        ...
        <hr />
        <div className="text-center text-white py-4">Designed With <span className=' animate-pulse'>&#10084;</span> By <span className="text-amber-500 italic">Sumit Patel</span></div>
    </footer>
    </>
  )
}
