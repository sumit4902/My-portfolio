...
export default function HeroSection() {
  ...
  return (
    <>
    <div className="  bg-[radial-gradient(ellipse_at_bottom,_var(--tw-gradient-stops))] from-[#588983f8] to-[#041b19f3] ">
            <div className=" mx-auto w-[100%] mobile:max-w-[540px] ipadmini:max-w-[768px] ipadair:max-w-[960px] laptop:max-w-[1400px]  ">
              
               <div className=" flex ipadmini:flex-row flex-col  ">
                {/* leftpart */}
                <div className="ipadmini:w-1/2 w-full p-4  flex  flex-col justify-center items-center ">
                  <span className=" text-5xl font-semibold p-2 flex flex-col gap-y-2">
                  <span className="p-2 text-[#f1fcfe] ">Hey There,</span> 
                  <span className="p-2  text-[#f1fcfe]   ">I'm Sumit</span></span>
                 
                </div>
                {/* rightpart */}
                <div className=" ipadmini:w-1/2 w-full p-4 flex justify-center items-center">
                  <div className=" p-2 text-[#f1fcfe] font-medium text-3xl"> I am FullStack Developer</div>
                  
                </div>
               </div>

               <div className="flex ipadmini:flex-row flex-col gap-y-4 ">
                <div className="ipadmini:w-[33%] w-full p-2  flex ipadmini:justify-end justify-center items-center">
                  <div className=" flex ipadmini:flex-col  items-center  ipadmini:me-12">
                  <a href='https://drive.google.com/file/d/1IAfB2apu28VHnr9i54bSgUz4oMKYkYfu/view' target='/' className='m-4 border px-6 py-2 rounded active:scale-[1.06] font-medium text-[#f1fcfe] bg-[#142e2cf3]'>Get Resume</a>
                   <span onClick={()=>setModel(true)} className="p-2 m-2 h-12 w-14 animate-ping  rounded-full text-[#f1fcfe]">
                    <img src="/videologo.png" alt='Not found' className=" h-full w-full rounded-full" />
                   </span>
                  </div>
                </div>
                <div className="ipadmini:w-[33%] w-full p-2 text-center h-[23rem]   flex justify-center items-end">
                  <img src="/sumit'sphoto.png" alt=""  className='w-[280px] h-[370px] rounded-full  border-b-4 border-sky-700' />
                </div>
                <div className="ipadmini:w-[34%] w-full p-2  flex justify-center items-center">
                 
                  <div className="p-2 flex ipadmini:flex-col gap-y-2 gap-x-2  ">
                   
                  <div className=" flex ipadmini:flex-col flex-row gap-y-7  gap-x-9 justify-around w-full">
 ...
 {/* personal vedio */}
               <div className={`${model?"":"hidden"} fixed flex flex-col justify-center items-center top-0 left-0 right-0 min-h-screen z-40 backdrop-blur-md  laptop:px-44 ipadmini:px-36 px-8`}>
                     
                     <div className=" max-w-[750px] ">
                       <div className=" flex justify-end   py-1">
                         <span onClick={()=>{setModel(false)}} className="text-white">
                       ...
                       <br />
                       <div className="">
                         <p className='text-white'>Introduction Vedio is coming soon</p>
                         {/* // eslint-disable-next-line */}
                          <iframe src="https://drive.google.com/file/d/1SHIDWMZbfrPbOyB9TA9Vsis4a_VHTLF6/preview" title="intro" height="440" allow="autoplay" className='w-[370px] ipadmini:w-[600px] border-4 shadow-lg shadow-zinc-300  rounded-md'></iframe>
                       </div>
                     </div>
               </div>
